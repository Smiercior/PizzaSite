...
<div class="container-fluid overflow-hidden px-0 bg-black">
    ...
    <div class="row w-25 mt-4 mb-4 border mx-auto">
        ...
        <div class="col-12 text-center text-warning mt-1">
            ...
            <?php else: ?>
                <span class="text-danger span4">Brak produktów</span>
            <?php endif ?>
        </div>
            
        <div class="p-2 col-12 text-start ml-2 bg-dark border mt-2">
            <span class="text-light span4">Sposób realizacji</span>
        </div>
        ...
        <form class="m-0 p-0" method="POST">
                ...
                <div class="col-12">
                    <div class="form-check w-50 mx-auto text-start">
                        ...
                        <label class="form-check-label text-light" for="flexRadioDefault1">
                            <span class="span6">Odbiór osobisty</span>
                        </label>
                    </div>
                </div>
            ...
            <div class="p-2 col-12 text-start ml-2 bg-dark border mt-2">
                ...
                <span class="text-light span4">Kwota: <span class="text-warning"><?= $sum ?>zł</span></span>
            </div>

            <div class="col-12 w-50 mx-auto mt-2">
                <input type="submit" name="makeOrder" class="btn-outline-success btn btnC bg-dark form-control" value="Zamów">
            </div>
        ...
        <div class="col-12 w-50 p-0 mx-auto mt-1 mb-2">
            <form method="GET">
                <input class="btn-outline-danger btn btnC bg-dark form-control" type="submit" name="clearCart" value="Wyczyść koszyk">
            </form>
        </div>
